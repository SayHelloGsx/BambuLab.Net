...
public class BambuLabPrinterWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public BambuLabPrinterWebHostMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<BambuLabPrinterResource>();
