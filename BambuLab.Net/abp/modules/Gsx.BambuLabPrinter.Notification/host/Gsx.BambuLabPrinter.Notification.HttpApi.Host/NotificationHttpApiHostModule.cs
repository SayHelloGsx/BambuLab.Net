...
public class NotificationHttpApiHostModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.KeyPrefix = "Notification:";
        });

        var dataProtectionBuilder = context.Services.AddDataProtection().SetApplicationName("Notification");
        if (!hostingEnvironment.IsDevelopment())
        {
            var redis = ConnectionMultiplexer.Connect(configuration["Redis:Configuration"]!);
            dataProtectionBuilder.PersistKeysToStackExchangeRedis(redis, "Notification-Protection-Keys");
        }
